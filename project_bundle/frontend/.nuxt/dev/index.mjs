...
import { eventHandler, setHeaders, sendRedirect, defineEventHandler, handleCacheHeaders, createEvent, getRequestHeader, getRequestHeaders, setResponseHeader, createApp, createRouter as createRouter$1, lazyEventHandler, toNodeListener, getQuery, createError } from 'file:///app/node_modules/h3/dist/index.mjs';
...
import { parseURL, withQuery, joinURL } from 'file:///app/node_modules/ufo/dist/index.mjs';
...
import { createStorage } from 'file:///app/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///app/node_modules/unstorage/dist/drivers/fs.mjs';
import defu from 'file:///app/node_modules/defu/dist/defu.mjs';
import { toRouteMatcher, createRouter } from 'file:///app/node_modules/radix3/dist/index.mjs';

const _runtimeConfig = {"app":{"baseURL":"/","buildAssetsDir":"/_nuxt/","cdnURL":""},"nitro":{"routeRules":{"/__nuxt_error":{"cache":false}},"envPrefix":"NUXT_"},"public":{"apiBase":"http://localhost:8000"},"apiBase":"http://web:8000"};
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","base":"/app","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","base":"/app/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","base":"/app/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","base":"/app/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
...
const errorHandler = (async function errorhandler(error, event) {
  ...
  if (!res) {
    const { template } = await import('file:///app/node_modules/@nuxt/ui-templates/dist/templates/error-dev.mjs') ;
    {
